...
1. Visit [Shield](https://shield-pi.vercel.app)
...
2. **Expiration Time**: Set when the link should expire
   - Options: 1 hour, 24 hours, 7 days, or custom
...
<Info>
The link looks like: `https://shield-pi.vercel.app/r/<policyId>`
</Info>
...
2. You'll be redirected to the Shield verification page

...
1. Visit [Shield](https://app.shieldhq.xyz)
...
<Info>
  The link looks like: `https://app.shieldhq.xyz/r/<policyId>`
</Info>
...
<CardGroup cols={2}>
  <Card title="Smart Contract" icon="file-contract" href="/developers">
